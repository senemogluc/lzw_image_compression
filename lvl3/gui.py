...
import  os
from    image_compression3  import lvl3, get_size
...
def start():
    ...
    if os.path.exists("lvl3/compressed.bin"):
       os.remove("lvl3/compressed.bin")
    open("lvl3/compressed.bin", "x")
    ...
    btn2['command'] = lambda:[lvl3(),modify_image(pimg_panel),modify_size(pimg_size_label)]
