...
import  os
from    image_compression5  import process_red, process_green, process_blue, get_size
...
def start():
    if os.path.exists("lvl5/compressed.bin"):
       os.remove("lvl5/compressed.bin")
    open("lvl5/compressed.bin", "x")
    ...
    pimg_size_label.grid(row = 3, column=5, columnspan=4)
    ...
    # Blue Scale button
    btn2 = tk.Button(frame, text = 'Blue Scale', bg = 'lightblue', width = 10)
